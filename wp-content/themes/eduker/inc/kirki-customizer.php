...
function dustrilox_customizer_panels_sections($wp_customize)
{
    ...
    $wp_customize->add_section('event_settings', [
        'title' => esc_html__('Event Settings ', 'dustrilox'),
        'description' => '',
        'priority' => 19,
        'capability' => 'edit_theme_options',
        'panel' => 'dustrilox_customizer',
...
function _header_top_fields($fields)
{
    ...
    $fields[] = [
        'type' => 'text',
        'settings' => 'dustrilox_acc_button_text',
        'label' => esc_html__('Login', 'dustrilox'),
        'section' => 'header_top_setting',
        'default' => esc_html__('Login', 'dustrilox'),
        'priority' => 10,
    ];

    $fields[] = [
        'type' => 'text',
        'settings' => 'dustrilox_acc_button_link',
        'label' => esc_html__('Account URL', 'dustrilox'),
        'section' => 'header_top_setting',
        'default' => esc_html__('#', 'dustrilox'),
        'priority' => 10,
    ];
...
function _header_page_title_fields($fields)
{
    ...
    $fields[] = [
        ...
        'label' => esc_html__('Breadcrumb Hide', 'dustrilox'),
        'section' => 'breadcrumb_setting',
        'default' => '1',
        'priority' => 10,
        'choices' => [
...
function dustrilox_color_fields($fields)
{
    ...
    $fields[] = [
        ...
        'label' => __('Theme Color 1', 'dustrilox'),
    ...
    $fields[] = [
        ...
        'label' => __('Theme Color 2', 'dustrilox'),
        'description' => esc_html__('This is a Theme color control.', 'dustrilox'),
        'section' => 'color_setting',
        'default' => '#258E46',
        'priority' => 10,
    ...
    $fields[] = [
        ...
        'label' => __('Theme Color 3', 'dustrilox'),
        'description' => esc_html__('This is a Theme color control.', 'dustrilox'),
        'section' => 'color_setting',
        'default' => '#007A70',
        'priority' => 10,
 ...
 * Added Event Fields
 */
function dustrilox_event_fields($fields)
{
    // event settings
    $fields[] = [
        'type' => 'text',
        ...
        'default' => esc_html__('Enroll Now', 'dustrilox'),
        'priority' => 10,
    ];
    $fields[] = [
        'type' => 'text',
        'settings' => 'event_btn_link',
        'label' => esc_html__('Button Link', 'dustrilox'),
        'section' => 'event_settings',
        'default' => esc_html__('#', 'dustrilox'),
        'priority' => 10,
    ];
...
add_filter('kirki/fields', 'dustrilox_event_fields');
