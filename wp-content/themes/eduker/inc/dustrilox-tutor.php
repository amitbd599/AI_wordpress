      ...
      <div class="course__meta d-flex align-items-center justify-content-between">
         ...
         <div class="course__lesson">
            <span><i class="far fa-book-alt"></i>
               ...
               <?php print esc_html__('lessons', 'dustrilox'); ?>
            </span>
         </div>
...
add_action('dustrilox_course_lesson', 'dustrilox_lesson');

// dustrilox instructor
function dustrilox_instructor()
{
   global $post, $authordata;
...
add_action('dustrilox_course_instructor', 'dustrilox_instructor');

// dustrilox footer
function dustrilox_course_top_meta()
{
   global $post, $authordata;
   $profile_url = tutor_utils()->profile_url($authordata->ID);
      ...
      <div class="course__top-2 d-flex align-items-center justify-content-between">
         ...
         <div class="course__price-2">
            <span>
               ...
               $default_price = apply_filters('tutor-loop-default-price', __('Free', 'dustrilox'));
               ...
               echo dustrilox_kses_intermediate($price_html);
               ?>
            </span>
         </div>
      </div>
...
add_action('dustrilox_course_price_cat', 'dustrilox_course_top_meta');

// dustrilox footer
function dustrilox_course_enroll_info()
{
   global $post, $authordata;
   ...
   $dustrilox_tutor_course_details_payment_switch = get_theme_mod('dustrilox_tutor_course_details_payment_switch', true);
   ?>
         ...
         <ul>
            <li class="d-flex align-items-center">
               ...
               <div class="course__video-info">
                  <h5><span><?php _e('Instructor :', 'dustrilox'); ?></span>
                     <?php echo get_the_author_meta('display_name', get_the_author_meta('ID')); ?></h5>
               </div>
            </li>
            <li class="d-flex align-items-center">
               <div class="course__video-icon">
               ...
               <div class="course__video-info">
                  <h5><span><?php _e('Lectures :', 'dustrilox'); ?></span><?php print esc_html($tutor_lesson_count); ?></h5>
               </div>
            </li>
            <?php if (!empty($course_duration) && !$disable_course_duration): ?>
                  <li class="d-flex align-items-center">
                     ...
                     <div class="course__video-info">
                        <h5><span><?php _e('Duration :', 'dustrilox'); ?></span><?php echo esc_html($course_duration); ?></h5>
                     </div>
                  </li>
            <?php endif; ?>
            <?php if (!$disable_total_enrolled): ?>
                  <li class="d-flex align-items-center">
                     ...
                     <div class="course__video-info">
                        <h5>
                           <span><?php _e('Enrolled :', 'dustrilox'); ?></span><?php echo (int) tutor_utils()->count_enrolled_users_by_course(); ?>
                           <?php _e('students', 'dustrilox'); ?></h5>
                     </div>
                  </li>
            <?php endif; ?>
            <?php if (!$disable_course_level): ?>
                  <li class="d-flex align-items-center">
                     ...
                     <div class="course__video-info">
                        <h5><span><?php _e('Course level :', 'dustrilox'); ?></span><?php echo get_tutor_course_level(); ?></h5>
                     </div>
                  </li>
            <?php endif; ?>
            ...
            <li class="d-flex align-items-center">
               ...
               <div class="course__video-info">
                  <h5><span><?php _e('Language :', 'dustrilox'); ?></span><?php print esc_html($course_language); ?></h5>
               </div>
            </li>
...
add_action('dustrilox_course_enroll_info_list', 'dustrilox_course_enroll_info');

// dustrilox single tab
function dustrilox_course_info_tab()
{
   global $post, $authordata;
   $course_tags = get_tutor_course_tags();
   $disable_course_share = get_tutor_option('disable_course_share');
   $dustrilox_tutor_course_desc_tab_switch = get_theme_mod('dustrilox_tutor_course_desc_tab_switch', true);
   $dustrilox_tutor_course_curriculum_tab_switch = get_theme_mod('dustrilox_tutor_course_curriculum_tab_switch', true);
   $dustrilox_tutor_course_reviews_tab_switch = get_theme_mod('dustrilox_tutor_course_reviews_tab_switch', true);
   $dustrilox_tutor_course_instructor_tab_switch = get_theme_mod('dustrilox_tutor_course_instructor_tab_switch', true);
   ?>
      <div class="course__tab-2 mb-45">
         <ul class="nav nav-tabs" id="courseTab" role="tablist">
            <?php if (!empty($dustrilox_tutor_course_desc_tab_switch)): ?>
                  <li class="nav-item" role="presentation">
                     <button class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description"
                        type="button" role="tab" aria-controls="description" aria-selected="true"> <i class="icon_ribbon_alt"></i>
                        <span><?php _e('Discription', 'dustrilox'); ?></span> </button>
                  </li>
            <?php endif; ?>

            <?php if (!empty($dustrilox_tutor_course_curriculum_tab_switch)): ?>
                  <li class="nav-item" role="presentation">
                     <button class="nav-link " id="curriculum-tab" data-bs-toggle="tab" data-bs-target="#curriculum" type="button"
                        role="tab" aria-controls="curriculum" aria-selected="false"> <i class="icon_book_alt"></i>
                        <span><?php _e('Curriculum', 'dustrilox'); ?></span> </button>
                  </li>
            <?php endif; ?>

            <?php if (!empty($dustrilox_tutor_course_reviews_tab_switch)): ?>
                  <li class="nav-item" role="presentation">
                     <button class="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#review" type="button" role="tab"
                        ...
                        <span><?php _e('Reviews', 'dustrilox'); ?></span> </button>
                  </li>
            <?php endif; ?>

            <?php if (!empty($dustrilox_tutor_course_instructor_tab_switch)): ?>
                  <li class="nav-item" role="presentation">
                     <button class="nav-link" id="member-tab" data-bs-toggle="tab" data-bs-target="#member" type="button" role="tab"
                        ...
                        <span><?php _e('Instructor', 'dustrilox'); ?></span> </button>
                  </li>
            <?php endif; ?>
         </ul>
      </div>
...
add_action('dustrilox_course_info_tab_action', 'dustrilox_course_info_tab');