...
function dustrilox_register_required_plugins()
{
    ...
    $plugins = [
        ...
        [
            ...
            'slug' => 'tp-core',
            'source' => esc_url('https://wp.hixstudio.net/dustrilox/source/tp-core.zip'),
            'required' => true,
            'external_url' => esc_url('https://wp.hixstudio.net/dustrilox/source/tp-core.zip'),
        ],
        [
        ...
        array(
            'name' => esc_html__('WooCommerce', 'dustrilox'),
            'slug' => 'woocommerce',
            'required' => false,
        ),
        array(
            'name' => esc_html__('YITH WooCommerce Wishlist', 'dustrilox'),
            'slug' => 'yith-woocommerce-wishlist',
            'required' => false,
        ),
        array(
            'name' => esc_html__('YITH WooCommerce Quick View', 'dustrilox'),
            'slug' => 'yith-woocommerce-quick-view',
            'required' => false,
        ),
        array(
            'name' => esc_html__('Event Manager – Eventin', 'dustrilox'),
