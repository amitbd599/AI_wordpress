...
$dustrilox_phone = get_theme_mod('dustrilox_phone', __('786 686 350 36', 'dustrilox'));
         ...
         <div class="col-xl-3 col-lg-4 d-none d-lg-block">
            <div class="header-info f-right">
               <div class="info-item info-item-right">
                  ...
                  <h5><a href="tel:+88096389">
                        <?php echo esc_html($dustrilox_phone); ?>
                     </a></h5>
               </div>
               <div class="info-item">
                  <span>
                     <?php echo esc_html__('Email Address', 'dustrilox') ?>
                  </span>
                     ...
                     <div class="header__top-right d-flex justify-content-end align-items-center">
                        <?php if (!empty($dustrilox_acc_button_text)): ?>
                           <div class="header__login">
                              <a href="<?php echo esc_html($dustrilox_acc_button_link); ?>"><svg viewBox="0 0 12 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <?php if (!empty($dustrilox_button_text)): ?>
                           <div class="header__btn ml-20">
                              <a href="<?php echo esc_html($dustrilox_button_link); ?>"
                                 class="header-btn"><?php echo esc_html($dustrilox_button_text); ?></a>
                           </div>
                        <?php endif; ?>
                           ...
                           <form action="<?php print esc_url(home_url('/')); ?>">
                              <div class="header__search-input">
                                 <input type="text" name="s" value="<?php print esc_attr(get_search_query()) ?>"
                                    placeholder="<?php print esc_attr__('Search...', 'dustrilox'); ?>">

                                 <button type="submit" class="header__search-btn"><svg width="18" height="18"
