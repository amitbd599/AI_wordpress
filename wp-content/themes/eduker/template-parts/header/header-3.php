                  ...
                  <div class="header__call d-flex align-items-start">
                     ...
                     <div class="header__call-content">
                        <?php if (!empty($dustrilox_phone_num)): ?>
                              <h4><a
                                    href="tel:<?php echo esc_attr($dustrilox_phone_num); ?>"><?php echo esc_html($dustrilox_phone_num); ?></a>
                              </h4>
                        <?php endif; ?>
                        <?php if (!empty($dustrilox_mail_id)): ?>
                              <p><a
                                    href="mailto:<?php echo esc_attr($dustrilox_mail_id); ?>"><?php echo esc_html($dustrilox_mail_id); ?></a>
                              </p>
                        <?php endif; ?>
                     </div>
                  </div>
                     ...
                     <?php if (!empty($dustrilox_acc_button_link)): ?>
                           <div class="header__login-2 d-none d-md-flex align-items-center ml-20 pl-20">
                              ...
                              <div class="header__login-content">
                                 <p><a
                                       href="<?php echo esc_html($dustrilox_acc_button_link); ?>"><?php echo esc_html__('Login', 'dustrilox'); ?></a>
                                 </p>
                                 <p><a
                                       href="<?php echo esc_html($dustrilox_acc_button_link); ?>"><?php echo esc_html__('Register', 'dustrilox'); ?></a>
                                 </p>
                              </div>
                           </div>
                     <?php endif; ?>
                                       ...
                                       <button class="header__search-btn" type="submit">
                                          <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                             ...
                                             <path
                                                ...
                                                stroke="#3E8454" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
