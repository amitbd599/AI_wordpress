...
$event_btn_text = get_theme_mod('event_btn_text', __('Enroll Now', 'dustrilox'));
$event_btn_link = get_theme_mod('event_btn_link', __('#', 'dustrilox'));
            ...
            <ul>
                ...
                if (!isset($event_options["etn_hide_date_from_details"])):
                    ...
                    <li class="d-flex align-items-center">
                        ...
                        <div class="event__info-item">
                            <h5><span><?php echo esc_html__('End', 'dustrilox'); ?> :</span>
                ...
                if (!isset($event_options["etn_hide_time_from_details"]) && (!empty($data['event_start_time']) || !empty($data['event_end_time']))):
                    ...
                    <li class="d-flex align-items-center">
                        ...
                        <div class="event__info-item">
                            <h5><span><?php echo esc_html__('Time', 'dustrilox'); ?> :</span>
                ...
                if (!class_exists('Wpeventin_Pro') || get_post_meta($single_event_id, 'etn_event_location_type', true) != 'new_location'):
                    ...
                    if (!empty($location)):
                        ...
                        <li class="d-flex align-items-center">
                            ...
                            <div class="event__info-item">
                                <h5><span><?php echo esc_html__('Venue', 'dustrilox'); ?> :</span>
