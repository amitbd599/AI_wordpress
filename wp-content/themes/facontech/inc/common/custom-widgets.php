...
class facontech_sidebar_social_widget extends WP_Widget
{
...
?>
        ...
        <p>
            ...
            <input class="widefat" name="<?php echo $this->get_field_name('quora'); ?>"
                value="<?php echo esc_attr($quora); ?>" type="text">
        </p>
...
class facontech_footer_social_widget extends WP_Widget
{
...
// Register widget
function facontech_register_social_widget()
{
    register_widget('facontech_sidebar_social_widget');
    register_widget('facontech_footer_social_widget');
}
add_action('widgets_init', 'facontech_register_social_widget');
