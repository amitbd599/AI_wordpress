   ...
   <div class="course__meta d-flex align-items-center justify-content-between">
      ...
      <div class="course__lesson">
         <span><i class="far fa-book-alt"></i>
            ...
            <?php print esc_html__('lessons', 'facontech'); ?>
         </span>
      </div>
...
add_action('facontech_course_lesson', 'facontech_lesson');

// facontech instructor
function facontech_instructor()
{
   global $post, $authordata;
   ...
   <div class="course__teacher d-flex align-items-center">
      ...
      <h6><a href="<?php echo esc_url($profile_url); ?>">
...
add_action('facontech_course_instructor', 'facontech_instructor');

// facontech footer
function facontech_course_top_meta()
{
   global $post, $authordata;
   $profile_url = tutor_utils()->profile_url($authordata->ID);
   ...
   <div class="course__top-2 d-flex align-items-center justify-content-between">
      ...
      <div class="course__price-2">
         <span>
            ...
            $default_price = apply_filters('tutor-loop-default-price', __('Free', 'facontech'));
            ...
            echo facontech_kses_intermediate($price_html);
            ?>
         </span>
      </div>
   </div>
...
add_action('facontech_course_price_cat', 'facontech_course_top_meta');

// facontech footer
function facontech_course_enroll_info()
{
   global $post, $authordata;
   ...
   $facontech_tutor_course_details_payment_switch = get_theme_mod('facontech_tutor_course_details_payment_switch', true);
   ?>
   <div class="course__video-content mb-35">
      <ul>
         ...
         <li class="d-flex align-items-center">
            ...
            <div class="course__video-info">
               <h5><span>
                     <?php _e('Language :', 'facontech'); ?>
                  </span>
                  <?php print esc_html($course_language); ?>
               </h5>
            </div>
         </li>
...
add_action('facontech_course_enroll_info_list', 'facontech_course_enroll_info');

// facontech single tab
function facontech_course_info_tab()
{
   global $post, $authordata;
   $course_tags = get_tutor_course_tags();
   $disable_course_share = get_tutor_option('disable_course_share');
   $facontech_tutor_course_desc_tab_switch = get_theme_mod('facontech_tutor_course_desc_tab_switch', true);
   $facontech_tutor_course_curriculum_tab_switch = get_theme_mod('facontech_tutor_course_curriculum_tab_switch', true);
   $facontech_tutor_course_reviews_tab_switch = get_theme_mod('facontech_tutor_course_reviews_tab_switch', true);
   $facontech_tutor_course_instructor_tab_switch = get_theme_mod('facontech_tutor_course_instructor_tab_switch', true);
   ?>
   <div class="course__tab-2 mb-45">
      <ul class="nav nav-tabs" id="courseTab" role="tablist">
         <?php if (!empty($facontech_tutor_course_desc_tab_switch)): ?>
            <li class="nav-item" role="presentation">
               <button class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description"
                  type="button" role="tab" aria-controls="description" aria-selected="true"> <i class="icon_ribbon_alt"></i>
                  <span>
                     <?php _e('Discription', 'facontech'); ?>
                  </span> </button>
            </li>
         <?php endif; ?>

         <?php if (!empty($facontech_tutor_course_curriculum_tab_switch)): ?>
            <li class="nav-item" role="presentation">
               <button class="nav-link " id="curriculum-tab" data-bs-toggle="tab" data-bs-target="#curriculum" type="button"
                  role="tab" aria-controls="curriculum" aria-selected="false"> <i class="icon_book_alt"></i> <span>
                     <?php _e('Curriculum', 'facontech'); ?>
                  </span> </button>
            </li>
         <?php endif; ?>

         <?php if (!empty($facontech_tutor_course_reviews_tab_switch)): ?>
            <li class="nav-item" role="presentation">
               <button class="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#review" type="button" role="tab"
                  aria-controls="review" aria-selected="false"> <i class="icon_star_alt"></i> <span>
                     <?php _e('Reviews', 'facontech'); ?>
                  </span> </button>
            </li>
         <?php endif; ?>

         <?php if (!empty($facontech_tutor_course_instructor_tab_switch)): ?>
            <li class="nav-item" role="presentation">
               <button class="nav-link" id="member-tab" data-bs-toggle="tab" data-bs-target="#member" type="button" role="tab"
                  aria-controls="member" aria-selected="false"> <i class="fal fa-user"></i> <span>
                     <?php _e('Instructor', 'facontech'); ?>
                  </span> </button>
            </li>
         <?php endif; ?>
...
add_action('facontech_course_info_tab_action', 'facontech_course_info_tab');