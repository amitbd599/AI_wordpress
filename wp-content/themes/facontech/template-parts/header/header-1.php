               ...
               <div class="row align-items-center">
                     ...
                     <div class="header__info">
                        <ul>
                           <?php if (!empty($facontech_mail_id)): ?>
                              <li>
                                 <a href="mailto:<?php echo esc_attr($facontech_mail_id); ?>">
                           ...
                           <?php if (!empty($facontech_address)): ?>
                              <li>
                                 <a href="<?php echo esc_html($facontech_address_url); ?>" target="_blank">
                  ...
                  <div class="col-xxl-6 col-xl-4 col-lg-4 col-md-4">
                     <div class="header__top-right d-flex justify-content-end align-items-center">
                        <?php if (!empty($facontech_acc_button_text)): ?>
                           <div class="header__login">
                              <a href="<?php echo esc_html($facontech_acc_button_link); ?>"><svg viewBox="0 0 12 14"
                                 ...
                                 <?php echo esc_html($facontech_acc_button_text); ?>
                              </a>
                           </div>
                        <?php endif; ?>

                        <?php if (!empty($facontech_button_text)): ?>
                           <div class="header__btn ml-20">
                              <a href="<?php echo esc_html($facontech_button_link); ?>" class="header-btn">
                                 <?php echo esc_html($facontech_button_text); ?>
                              </a>
                           </div>
                        <?php endif; ?>
