                  ...
                  <div class="header__call d-flex align-items-start">
                     ...
                     <div class="header__call-content">
                        <?php if (!empty($facontech_phone_num)): ?>
                           <h4><a href="tel:<?php echo esc_attr($facontech_phone_num); ?>">
                                 <?php echo esc_html($facontech_phone_num); ?>
                              </a></h4>
                        <?php endif; ?>
                        <?php if (!empty($facontech_mail_id)): ?>
                           <p><a href="mailto:<?php echo esc_attr($facontech_mail_id); ?>">
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-8 col-6">
                  <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                     <div class="header__lang d-none d-md-block">
                        <?php facontech_header_lang_defualt(); ?>
                     </div>
                     ...
                     <?php if (!empty($facontech_acc_button_link)): ?>
                        <div class="header__login-2 d-none d-md-flex align-items-center ml-20 pl-20">
                           ...
                           <div class="header__login-content">
                              <p><a href="<?php echo esc_html($facontech_acc_button_link); ?>">
                                    <?php echo esc_html__('Login', 'facontech'); ?>
                                 </a></p>
                              <p><a href="<?php echo esc_html($facontech_acc_button_link); ?>">
                                    <?php echo esc_html__('Register', 'facontech'); ?>
                                 </a></p>
                           </div>
                        </div>
                     <?php endif; ?>
