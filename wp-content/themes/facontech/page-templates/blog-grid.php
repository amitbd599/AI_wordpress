...
<main>
   ...
   <section class="blog-section blog-grid one">
      <div class="container">
         <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
               <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                  ...
                  <div class="text-file">
                     ...
                     <div class="title">
                        <h2><a href="blog-details.html">Professional Technology information & Solutions...</a>
                        </h2>
            ...
            <div class="col-lg-4 col-md-6 col-12">
               <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                  <div class="img-file">
                  ...
                  <div class="text-file">
                     ...
                     <div class="title">
                        <h2><a href="blog-details.html">We offer AI consulting services and solutions...</a></h2>
                        <p>Lorem ipsum dolor sit amet, coned sectetur notte elit sed do.</p>
                     </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
               <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                  ...
                  <div class="text-file">
                     ...
                     <div class="title">
                        <h2><a href="blog-details.html">AI Services is a collection with prebuilt...</a>
                        </h2>
                        <p>Lorem ipsum dolor sit amet, coned sectetur notte elit sed do.</p>
                     </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
               <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                  <div class="img-file">
                     <img class="img-fluid" src="./assets/img/blog/04_blog.png" alt="">
                  </div>
                  <div class="text-file">
                     <div class="intro">
                        <div class="d-flex gap-3 align-items-center">
                     ...
                     <div class="title">
                        <h2><a href="blog-details.html">The Security Risks Of Changing Owners...</a></h2>
                        <p>Lorem ipsum dolor sit amet, coned sectetur notte elit sed do.</p>
                     </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
               <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                  <div class="img-file">
                     <img class="img-fluid" src="./assets/img/blog/05_blog.png" alt="">
                  </div>
                  <div class="text-file">
                     <div class="intro">
                        <div class="d-flex gap-3 align-items-center">
                     ...
                     <div class="title">
                        <h2><a href="blog-details.html">Avenga AI services help companies create AI...</a></h2>
                        <p>Lorem ipsum dolor sit amet, coned sectetur notte elit sed do.</p>
                     </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
               <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                  <div class="img-file">
                     <img class="img-fluid" src="./assets/img/blog/06_blog.png" alt="">
                  </div>
                  <div class="text-file">
                     <div class="intro">
                        <div class="d-flex gap-3 align-items-center">
                     ...
                     <div class="title">
                        <h2><a href="blog-details.html">Use the same proven AI power AI capabilities...</a></h2>
                        <p>Lorem ipsum dolor sit amet, coned sectetur notte elit sed do.</p>
                     </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
               <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                  <div class="img-file">
                     <img class="img-fluid" src="./assets/img/blog/07_blog.png" alt="">
                  </div>
                  <div class="text-file">
                     <div class="intro">
                        <div class="d-flex gap-3 align-items-center">
            ...
            <div class="col-lg-4 col-md-6 col-12">
               <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                  <div class="img-file">
                     <img class="img-fluid" src="./assets/img/blog/08_blog.png" alt="">
                  </div>
                  <div class="text-file">
                     <div class="intro">
                        <div class="d-flex gap-3 align-items-center">
            ...
            <div class="col-lg-4 col-md-6 col-12">
               <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                  <div class="img-file">
                     <img class="img-fluid" src="./assets/img/blog/09_blog.png" alt="">
                  </div>
                  <div class="text-file">
                     <div class="intro">
                        <div class="d-flex gap-3 align-items-center">
