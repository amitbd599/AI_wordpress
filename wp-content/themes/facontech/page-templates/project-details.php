            ...
            <div class="col-12">
               <div class="main-img">
                  <img class="img-fluid rounded"
                     src="<?php echo esc_url(get_template_directory_uri() . './assets/img/project/09_project.png'); ?>" alt="">
               </div>
               ...
               <div class="inner-des">
                  ...
                  <div class="grid-action mt-2">
                     <img class="img-fluid wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"
                        src="<?php echo esc_url(get_template_directory_uri() . './assets/img/project/01_project.png'); ?>" alt="">
                     <img class="img-fluid wow animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"
                        src="<?php echo esc_url(get_template_directory_uri() . './assets/img/project/02_project.png'); ?>" alt="">
                  </div>
                  <div class="mt-3">
