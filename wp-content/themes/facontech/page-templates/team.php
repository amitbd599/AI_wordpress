...
<main>
   ...
   <section class="team-section one single-row">
      <div class="container">
         <div class="row">
            <div class="col-xl-3 col-md-4 col-sm-6 col-12">
               <div class="inner-wrapper wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                  <div class="img-file">
                     <img class="img-fluid"
                        src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/team/01_team.png');  ?>" alt="Facontech">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 col-12">
               <div class="inner-wrapper wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                  <div class="img-file">
                     <img class="img-fluid"
                        src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/team/02_team.png'); ?>" alt="Facontech">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 col-12">
               <div class="inner-wrapper wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                  <div class="img-file">
                     <img class="img-fluid"
                        src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/team/03_team.png'); ?>" alt="Facontech">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 col-12">
               <div class="inner-wrapper wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                  <div class="img-file">
                     <img class="img-fluid"
                        src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/team/04_team.png'); ?>" alt="Facontech">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 col-12">
               <div class="inner-wrapper wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                  <div class="img-file">
                     <img class="img-fluid"
                        src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/team/05_team.png'); ?>" alt="Facontech">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 col-12">
               <div class="inner-wrapper wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                  <div class="img-file">
                     <img class="img-fluid"
                        src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/team/06_team.png'); ?>" alt="Facontech">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 col-12">
               <div class="inner-wrapper wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                  <div class="img-file">
                     <img class="img-fluid"
                        src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/team/07_team.png'); ?>" alt="Facontech">

                     <div class="shape-overlay">
                        <div class="inner-data">
                           <div>
                              <h3>Jeanice K. Medlin</h3>
                              <p>1478 Junior Avenue
                                 Forest Park, <br> NY 30050</p>
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 col-12">
               <div class="inner-wrapper wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                  <div class="img-file">
                     <img class="img-fluid"
                        src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/team/08_team.png'); ?>" alt="Facontech">
         ...
         <div class="row">
            <div class="col-12">
               <div class="pagination">
                  <ul>
                     <li><a href="#"><i class="fa-regular fa-chevrons-left"></i></a></li>
