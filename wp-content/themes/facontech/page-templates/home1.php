...
<main>
        ...
        <div class="swiper hero-slider-init-one swiper-container swiper-container-fade">
            <div class="swiper-wrapper p-relative">
                <div class="item-slider sliderm-height p-relative swiper-slide">
                    <div class="slide-bg" data-background="assets/img/bg-image/01_bg-image.png"></div>
                    <div class="container">
                        <div class="row ">
                ...
                <div class="item-slider sliderm-height p-relative swiper-slide">
                    <div class="slide-bg" data-background="assets/img/bg-image/02_bg-image.png"></div>
                    <div class="container">
                        <div class="row ">
                            <div class="col-xl-7 col-12">
                                <div class="slider-content-inner ">
                ...
                <div class="item-slider sliderm-height p-relative swiper-slide">
                    <div class="slide-bg" data-background="assets/img/bg-image/03_bg-image.png"></div>
                    <div class="container">
                        <div class="row ">
                            <div class="col-xl-7 col-12">
                                <div class="slider-content-inner ">
            ...
            <div class="shape-image">
                <div class="inner-shape-1 poa">
                    <img class="img-fluid" src="assets/img/icon/01_icon.png" alt="">
                </div>
                ...
                <div class="inner-shape-6 poa">
                    <img class="img-fluid" src="assets/img/icon/06_icon.png" alt="">
                </div>
                <div class="inner-shape-7 poa">
                    <img class="img-fluid" src="assets/img/icon/07_icon.png" alt="">
                </div>
                    ...
                    <div class="left-wrapper ">
                        <div class=" img-file ">
                            <img class=" img-fluid wow animated fadeInLeft" data-wow-duration="1.5s"
                                data-wow-delay="0.3s" src="./assets/img/about/01_about.png" alt="">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <p>Oracle Cloud Infrastructure (OCI) AI Services is a collection measure of how
                                            products and services Decorate of services with
                                            prebuilt machine learning models that make it.
                                        </p>
                                    </div>
                                </li>
                                <li>
    ...
    <section class="service-section one" data-background="./assets/img/shape/03_shape.svg">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title-shape-one middle wow animated fadeInUp" data-wow-duration="1.5s"
                        data-wow-delay="0.3s">
                        <h3>Explore
                            AWS AI Services</h3>
                        <h2>Explore Best & Awesome AI <br> <span class="theme-color">Services</span></h2>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <section class="project-section one">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title-shape-one middle wow animated fadeInUp" data-wow-duration="1.5s"
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="section-title-shape-one left wow animated fadeInLeft" data-wow-duration="1.5s"
                        ...
                        <p>As you may have read in our AI, ML, and deep learning post, ML is a subset of AI. Not all AI
                            systems learn from experience.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="swiper swiper-container team-one">
                                ...
                                <div class="img-file">
                                    ...
                                    <div class="shape-overlay">
                                        <div class="inner-data">
                                            <div>
                                                <h3>George Y. Huff</h3>
                                                <p>4536 Beeghley StreetTemple, <br> TX 76501</p>
                                ...
                                <div class="img-file">
                                    ...
                                    <div class="shape-overlay">
                                        <div class="inner-data">
                                            <div>
                                                <h3>Kandi P. Tighe</h3>
                                                <p>3423 Melville Street
                                                    Memphis, <br> TN 38141</p>
                                ...
                                <div class="img-file">
                                    ...
                                    <div class="shape-overlay">
                                        <div class="inner-data">
                                            <div>
                                                <h3>Joey E. Deal</h3>
                                                <p>2752 Lightning Point Drive
                                                    Memphis, <br> TN 38110</p>
                                    ...
                                    <div class="shape-overlay">
                                        <div class="inner-data">
                                            <div>
                                                ...
                                                <p>4141 Public Works Drive
                                                    Kingsport <br> TN 37663</p>
                                    ...
                                    <div class="shape-overlay">
                                        <div class="inner-data">
                                            <div>
                                                ...
                                                <p>4244 Golf Course Drive
                                                    Chantilly, <br> VA 22021</p>
                ...
                <div class="team-version-one-pagination pagination-button-design-one"></div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="award-part wow animated fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="title">
                            <h2>To be coworkers with <br> someone?</h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
    ...
    <section class="price-section one">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="section-title-shape-one left wow animated fadeInLeft" data-wow-duration="1s"
                        data-wow-delay="0.3s">
                        <h3>What We Offer </h3>
                        <h2>Our Best Pricing Plan <br> <span class="theme-color">For You</span></h2>
                        <p>As you may have read in our AI, ML, and deep learning post, ML is a subset of AI. Not all AI
                            systems learn from experience. Quis ipsum suspendisse ultrices gravida. Risus commodo.
                            ...
                            <div class="plan">
                                ...
                                <div class="list">
                                    <ul>
                                        ...
                                        <li class="deep">E-commerce Solutions </li>
                                        <li class="deep">Social Media Management </li>
                                        <li class="deep">Video & Animation Production </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title-shape-one middle wow animated fadeInUp" data-wow-duration="1s"
                        ...
                        <h2>People’s Say About Our <br> <span class="theme-color">Support & Services</span></h2>
                    </div>
                </div>
            </div>
            <div class="row por">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                        ...
                        <div class="text-file">
                            ...
                            <div class="title">
                                <h2><a href="#">We offer AI services and solutions.</a></h2>
                                <p>Lorem ipsum dolor sit amet, coned sectetur notte elit sed do.</p>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-items wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.6s">
                        ...
                        <div class="text-file">
                            ...
                            <div class="title">
                                <h2><a href="#">AI Services is a collection prebuilt.</a></h2>
                                <p>Lorem ipsum dolor sit amet, coned sectetur notte elit sed do.</p>
                            </div>
                        </div>
