...
esc_url(get_template_directory_uri() . './assets/img/team/01_team.png');

<main>

   <!-- Service Section One Start -->
   <section class="service-section one single-row"
      data-background="<?php echo esc_url(get_template_directory_uri() . './assets/img/shape/03_shape.svg'); ?>">
      <div class="container">

         <div class="row">
            <div class="col-lg-4 col-md-6">
               <div class="section-wrapper">
                  <div class="wrapper-inner one wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                     <div class="img-file">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="section-wrapper">
                  <div class="wrapper-inner one wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                     <div class="img-file">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="section-wrapper">
                  <div class="wrapper-inner one wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                     <div class="img-file">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="section-wrapper">
                  <div class="wrapper-inner one wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                     <div class="img-file">
                        <img src="<?php echo esc_url(get_template_directory_uri() . './assets/img/icon/85_icon.png'); ?>" alt="">
                     </div>
                     <div class="text-file">
                        <h3><a href="#">Facing Challenges</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati iste inventore
                           molestiae? Assumenda facilis.</p>
                     </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
               <div class="section-wrapper">
                  <div class="wrapper-inner one wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                     <div class="img-file">
                        <img src="<?php echo esc_url(get_template_directory_uri() . './assets/img/icon/86_icon.png'); ?>" alt="">
                     </div>
                     <div class="text-file">
                        <h3><a href="#">Heavy Industry</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati iste inventore
                           molestiae? Assumenda facilis.</p>
                     </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
               <div class="section-wrapper">
                  <div class="wrapper-inner one wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                     <div class="img-file">
                        <img src="<?php echo esc_url(get_template_directory_uri() . './assets/img/icon/87_icon.png'); ?>" alt="">
                     </div>
                     <div class="text-file">
