         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="section-wrapper">
                  <div class="wrapper-inner one wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                     <div class="img-file">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/icon/85_icon.png'); ?>" alt="Facontech">
                     </div>
                     <div class="text-file">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="section-wrapper">
                  <div class="wrapper-inner one wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.3s">
                     <div class="img-file">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/icon/86_icon.png'); ?>" alt="Facontech">
                     </div>
                     <div class="text-file">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="section-wrapper">
                  <div class="wrapper-inner one wow animated fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                     <div class="img-file">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/icon/87_icon.png'); ?>" alt="Facontech">
                     </div>
                     <div class="text-file">
