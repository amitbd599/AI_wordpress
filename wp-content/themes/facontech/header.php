...
<body <?php body_class(); ?>>
      ...
      <div id="loading">
         <div id="loading-center">
            <div id="loading-center-absolute">
               ...
               <img src="<?php echo esc_url($preloader_logo); ?>" alt="<?php echo esc_attr__('logo', 'facontech'); ?>">
            </div>
         </div>
      </div>
      <!-- pre loader area end -->
   ...
   <?php if (!empty($facontech_backtotops)): ?>
      <!-- back to top start -->
   ...
   <!-- wrapper-box start -->
   <?php do_action('facontech_before_main_content'); ?>