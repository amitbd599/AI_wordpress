...
class Hello_World extends Widget_Base
{
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			'section_content_1',
			[
				'label' => __('Content Info', 'elementor-hello-world'),
			]
		);
		...
		$this->add_control(
			'img',
			[
				'label' => __('img', 'elementor-hello-world'),
...
?>
		...
		<img src="<?php echo esc_attr($settings['img']['url']); ?>" alt="" srcset="">
		<?php var_dump($settings['img']['url']); ?>
	<?php
	}
