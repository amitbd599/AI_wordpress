<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'TS_portfolio_info_widget');
	function TS_portfolio_info_widget() {
		register_widget('TS_portfolio_info_widget');
	}


	class TS_portfolio_info_widget  extends WP_Widget{

		public function __construct(){
			parent::__construct('TS_portfolio_info_widget',esc_html__('TS Portfolio Info','TScore'),array(
				'description' => esc_html__('TS Portfolio Info Widget by Theme_Pure','TScore'),
			));
		}
