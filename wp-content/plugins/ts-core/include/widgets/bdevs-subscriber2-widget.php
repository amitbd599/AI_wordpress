<?php
	...
	class bdevs_subscriber2_widget  extends WP_Widget{
		...
		?>
				...
				<div class="ts-footer-subscribe-area-two position-relative pt-100">
					<div class="container">
						<div class="ts-footer-subscribe-bg-two theme-yellow-bg pt-30 pb-20 z-index pl-60 pr-60">
							<div class="row align-items-center">
								...
								<div class="col-xl-7 col-lg-8">
									<div class="ts-footer-subscribe-form ts-footer-subscribe-form-2">
