...
Class Latest_posts_footer2_Widget extends WP_Widget{
	...
	public function widget($args, $instance){
     	...
     	<?php endif; ?>
	     	...
	     	<div class="ts-footer-news ts-footer-news-three">
				...
				?>
		            <div class="ts-footer-news-single ts-footer-news-three-single mb-10">
		                <div class="ts-footer-news-three-single-img bg-blend">
		                    <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('thumbnail'); ?></a>
		                </div>
		                <div class="ts-footer-news-three-single-text">
