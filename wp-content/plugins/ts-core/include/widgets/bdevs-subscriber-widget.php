<?php
	...
	class Bdevs_Subscriber_Widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('bdevs_subscriber_widget',esc_html__('Bizker Footer Subscriber','tocore'),array(
		...
		?>
			...
			<div class="ts-footer-subscribe-area position-relative">
				<div class="ts-footer-subscribe-shape"></div>
				<div class="container">
					<div class="ts-footer-subscribe-bg theme-yellow-bg pt-30 pb-20 z-index">
						<div class="row align-items-center">
							<div class="col-xl-5 col-lg-4">
								<div class="ts-footer-subscribe">
									<?php if( !empty($instance['title']) ): ?>
									<h3 class="ts-footer-subscribe-title"><?php echo apply_filters( 'widget_title', $instance['title'] ); ?></h3>
									<?php endif; ?>
							...
							<div class="col-xl-7 col-lg-8">
								<div class="ts-footer-subscribe-form">
