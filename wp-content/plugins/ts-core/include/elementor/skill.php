 ...
 * @since 1.0.0
 */
class TS_Skill extends Widget_Base {
	...
	protected function render() {
		...
		<div class="about__skill__wrap mt-0">
			<?php
            foreach ( $settings['skills'] as $index => $skill ) : ?>
   			<div class="about__skill__item <?php echo esc_attr( $settings['view'] ); ?> elementor-repeater-item-<?php echo $skill['_id']; ?>">
                <h5 class="title"><?php echo esc_html( $skill['name'] ); ?></h5>
                <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: <?php echo esc_attr( $skill['level']['size'] ); ?>%;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
...
$widgets_manager->register( new TS_Skill() );