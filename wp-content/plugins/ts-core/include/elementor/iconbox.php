 ...
 * @since 1.0.0
 */
class TS_IconBox extends Widget_Base {
    use TS_Style_Trait;
	...
	protected function render() {
		...
		<?php if ( $settings['TS_design_style']  == 'layout-2' ):
            $this->add_render_attribute('title_args', 'class', 'research__title ts-el-title');
        ?>

        <div class="research__item research__item-border text-center mb-30 transition-3 ts-el-sec ">
		...
		<?php else:
			$this->add_render_attribute('title_args', 'class', 'contact__title ts-el-title');
            ...
            if ('2' == $settings['TS_btn_link_type']) {
                ...
                $this->add_render_attribute('ts-button-arg', 'class', 'ts-btn ts-btn-border ts-el-btn');
            } else {
        ...
        <div class="contact__item text-center mb-30 transition-3 white-bg ts-el-sec">
...
$widgets_manager->register( new TS_IconBox() );