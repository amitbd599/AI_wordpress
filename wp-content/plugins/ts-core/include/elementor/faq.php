 ...
 * @since 1.0.0
 */
class TS_FAQ extends Widget_Base {
	use TS_Style_Trait;
	/**
	...
	protected function register_controls_section() {
        ...
        $repeater->add_control(
            'accordion_title', [
                ...
                'default' => esc_html__( 'This is accordion item title' , 'TScore' ),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'accordion_title' => esc_html__( 'This is accordion item title #1', 'TScore' ),
                    ],
                    [
                        'accordion_title' => esc_html__( 'This is accordion item title #2', 'TScore' ),
                    ],
                    [
                        'accordion_title' => esc_html__( 'This is accordion item title #3', 'TScore' ),
                    ],
                    [
                        'accordion_title' => esc_html__( 'This is accordion item title #4', 'TScore' ),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Accordion space gap', 'TScore' ),
	...
	protected function style_tab_content()
	{
		...
		$this->TS_link_controls_style('', 'b_btn1_style', 'Button', '.ts-el-btn:after');
	}
                ...
                ?>
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="faqOne-<?php echo esc_attr($index); ?>">
                      <button class="accordion-button ts-el-title ts-el-btn <?php echo esc_attr($collapsed); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne-<?php echo esc_attr($index); ?>" aria-expanded="true" aria-controls="collapseOne-<?php echo esc_attr($index); ?>">
                    ...
                    <div id="collapseOne-<?php echo esc_attr($index); ?>" class="accordion-collapse collapse <?php echo esc_attr($show); ?>" aria-labelledby="faqOne-<?php echo esc_attr($index); ?>" data-bs-parent="#faqaccordion-<?php echo esc_attr($this->get_id()); ?>">
                      <div class="accordion-body">
                        <p class="ts-el-content"><?php echo TS_kses($item['accordion_description']); ?></p>
                      </div>
                    </div>
                  </div>
                  <?php endforeach; ?>
...
$widgets_manager->register( new TS_FAQ() );