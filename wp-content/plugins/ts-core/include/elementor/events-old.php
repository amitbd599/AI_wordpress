 ...
 * @since 1.0.0
 */
class TS_Events extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
            'TS_post_query',
            [
                'label' => esc_html__('Events Query', 'TScore'),
            ]
        );
        ...
        $this->start_controls_section(
            'TS_post_',
            [
                'label' => esc_html__('Event - Layout', 'TScore'),
            ]
        );
        $this->add_control(
            'TS_design_style',
          ...
          <div class="container">
            <div class="row">
                    ...
                    <div class="event__item white-bg mb-10 transition-3 p-relative d-lg-flex align-items-center justify-content-between">
                        <div class="event__left d-sm-flex align-items-center">
                           ...
                           <div class="event__content">
                              <div class="event__meta">
                                 <ul>
                                    <li>
                                       <a href="#"><svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="htTS://www.w3.org/2000/svg">
                        ...
                        <div class="event__right d-sm-flex align-items-center">
                           <div class="event__time">
                              <span>
                                 <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="htTS://www.w3.org/2000/svg">
                           ...
                           <div class="event__more ml-30">
                              <a href="<?php echo get_the_permalink(); ?>" class="ts-btn-5 ts-btn-7"><?php echo esc_html__('View Events','TScore'); ?></a>
                           </div>
                        </div>
                    </div>
              </div>
              <?php endwhile; wp_reset_query(); ?>
                ...
                <?php if($settings['TS_post_pagination'] == 'yes' && '-1' != $settings['posts_per_page'] ){ ?>
                    <div class="col-lg-12">
...
$widgets_manager->register( new TS_Events() );