 ...
 * @since 1.0.0
 */
class TS_Team extends Widget_Base {
    use TS_Style_Trait;
	...
	protected function register_controls_section() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'TS Member Title', 'TScore' ),
                'placeholder' => __( 'Type title here', 'TScore' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'show_label' => true,
                'label' => __( 'Job Title', 'TScore' ),
                'default' => __( 'TS Officer', 'TScore' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'show_label' => false,
                'placeholder' => __( 'Type link here', 'TScore' ),
                'default' => __( '#', 'TScore' ),
                'dynamic' => [
                    'active' => true,
                ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __( 'Website Address', 'TScore' ),
                'placeholder' => __( 'Add your profile link', 'TScore' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __( 'Google Plus', 'TScore' ),
                'placeholder' => __( 'Add your Google Plus link', 'TScore' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => false,
                'label' => __( 'Github', 'TScore' ),
                'placeholder' => __( 'Add your github link', 'TScore' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            'title_tag',
            [
                'label' => __( 'Title HTML Tag', 'TScore' ),
        ...
        $this->add_responsive_control(
            'align',
            [
                'label' => __( 'Alignment', 'TScore' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __( 'Left', 'TScore' ),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => __( 'Center', 'TScore' ),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => __( 'Right', 'TScore' ),
    ...
    protected function style_tab_content()
    {
        ...
        $this->TS_basic_style_controls('heading_title', 'Name', '.ts-el-title');
        $this->TS_basic_style_controls('heading_desc', 'Designation', '.ts-el-content');
	...
	protected function render() {
	    ...
	    <!-- style default -->
	    <?php else :
	        $this->add_render_attribute( 'title', 'class', 'team__title ts-el-title' );
	    ?>
            ...
            <div class="container">
               <div class="row">
                <?php foreach ( $settings['teams'] as $item ) :
                    $title = TS_kses( $item['title' ] );
                    $item_url = esc_url($item['item_url']);

                    if ( !empty($item['image']['url']) ) {
                        $TS_team_image_url = !empty($item['image']['id']) ? wp_get_attachment_image_url( $item['image']['id'], $settings['thumbnail_size']) : $item['image']['url'];
                        $TS_team_image_alt = get_post_meta($item["image"]["id"], "_wp_attachment_image_alt", true);
                    }
                ?>
                  <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                     <div class="team__item elementor-repeater-item-<?php echo esc_attr($item['_id']); ?> text-center mb-40">
                        <div class="team__thumb team__thumb-shape">
                           <?php if( !empty($TS_team_image_url) ) : ?>
                           <img src="<?php echo esc_url($TS_team_image_url); ?>" alt="<?php echo esc_attr($TS_team_image_alt); ?>">
                           <?php endif; ?>

                            <?php if( !empty($item['show_social'] ) ) : ?>
                            <div class="team__social transition-3 ts-el-btn">
                        ...
                        <div class="team__content">
                            ...
                            <span class="team__designation ts-el-content"><?php echo TS_kses( $item['designation'] ); ?></span>
                            <?php endif; ?>
                            <?php if( !empty($item['description']) ) : ?>
                            <p><?php echo TS_kses( $item['description'] ); ?></p>
                            <?php endif; ?>
...
$widgets_manager->register( new TS_Team() );