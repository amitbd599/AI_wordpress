 ...
 * @since 1.0.0
 */
class TS_Info_List_Box extends Widget_Base {
	...
	public function get_title() {
		return __( 'Info List Box', 'TScore' );
	}
	...
	protected function render() {
		...
		<?php if ( $settings['TS_design_style']  == 'layout-2' ):
            $this->add_render_attribute('title_args', 'class', 'title ts-el-title');
        ?>
		...
		<?php else:
			$this->add_render_attribute('title_args', 'class', 'category__title-3 ts-el-title');
            ...
            if ('2' == $settings['TS_btn_link_type']) {
                ...
                $this->add_render_attribute('ts-button-arg', 'class', 'ts-btn-9 w-100 ts-el-btn');
            } else {
        ...
        <div class="category__item-3 fix transition-3 white-bg mb-30 ts-el-sec">
            <?php
            if ( !empty($settings['TS_title' ]) ) :
                printf( '<%1$s %2$s>%3$s</%1$s>',
                    tag_escape( $settings['TS_title_tag'] ),
            ...
            <div class="category__list">
              <ul>
                 ...
                 <li>
                    <a class="ts-el-subtitle" href="<?php echo TS_kses($item['TS_features_url' ]); ?> ">
                        ...
                        <?php if($item['TS_features_icon_type'] !== 'image') : ?>
                            <?php if (!empty($item['TS_features_icon']) || !empty($item['TS_features_selected_icon']['value'])) : ?>
                                <span class="info_list_icon"><?php TS_render_icon($item, 'TS_features_icon', 'TS_features_selected_icon'); ?></span>
                            <?php endif; ?>
                        <?php else : ?>
            ...
            <?php if ( !empty($settings['TS_desctiption']) ) : ?>
                <p class="keyFeatureBlock__text ts-el-content"><?php echo TS_kses( $settings['TS_desctiption'] ); ?></p>
            <?php endif; ?>
...
$widgets_manager->register( new TS_Info_List_Box() );