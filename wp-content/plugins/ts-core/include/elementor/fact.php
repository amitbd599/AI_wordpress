 ...
 * @since 1.0.0
 */
class TS_Fact extends Widget_Base {
	...
	protected function register_controls_section() {
        ...
        if (TS_is_elementor_version('<', '2.6.0')) {
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => 'fa fa-star',
                    'condition' => [
                        'TS_fact_icon_type' => 'icon'
                    ]
                ]
            );
        } else {
            $repeater->add_control(
                'TS_fact_selected_icon',
                [
                    'show_label' => false,
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__('Food', 'TScore'),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'TS_fact_title' => esc_html__('Business Stratagy', 'TScore'),
                    ],
                    [
                        'TS_fact_title' => esc_html__('Website Development', 'TScore')
                    ],
                    [
                        'TS_fact_title' => esc_html__('Marketing & Reporting', 'TScore')
                    ],
                    [
                        'TS_fact_title' => esc_html__('Happy Client', 'TScore')
                    ]
                ],
                'title_field' => '{{{ TS_fact_title }}}',
            ]
        );
        ...
        // TS_fact_columns_section
        $this->start_controls_section(
            'TS_fact_columns_section',
            [
                'label' => esc_html__('Fact - Columns', 'TScore'),
            ]
        );
    ...
    protected function style_tab_content()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .ts-el-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .ts-el-content',
                'exclude' => [
                    'image'
                ]
            ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .ts-el-title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .ts-el-title' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .ts-el-subtitle' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ts-el-subtitle' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'subtitle',
                'selector' => '{{WRAPPER}} .ts-el-subtitle',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px'],
                'selectors' => [
                    '{{WRAPPER}} .ts-el-content p' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ts-el-content p' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'description',
                'selector' => '{{WRAPPER}} .ts-el-content p',
            ]
        );
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6 col-md-8">
                            <div class="section__title text-center  ts-el-content">
                    ...
                    <div class="services__style__two__wrap">
                        <div class="row gx-0">
                            <?php foreach ($settings['TS_fact_list'] as $item) :
                                // Link
                                if ('2' == $item['TS_fact_link_type']) {
                                    $link = get_permalink($item['TS_fact_page_link']);
                                    $target = '_self';
                                    $rel = 'nofollow';
                                } else {
                                    $link = !empty($item['TS_fact_link']['url']) ? $item['TS_fact_link']['url'] : '';
                                    $target = !empty($item['TS_fact_link']['is_external']) ? '_blank' : '';
                                    $rel = !empty($item['TS_fact_link']['nofollow']) ? 'nofollow' : '';
                                }
                            ...
                            <div class="col-xl-<?php echo esc_attr($settings['TS_col_for_desktop']); ?> col-lg-<?php echo esc_attr($settings['TS_col_for_laptop']); ?> col-md-<?php echo esc_attr($settings['TS_col_for_tablet']); ?> col-<?php echo esc_attr($settings['TS_col_for_mobile']); ?>">
                                <div class="services__style__two__item">
                                    <div class="services__style__two__icon">
                                        <?php if($item['TS_fact_icon_type'] !== 'image') : ?>
                                            <?php if (!empty($item['TS_fact_icon']) || !empty($item['TS_fact_selected_icon']['value'])) : ?>
                                                <div class="icon">
                                                    <?php TS_render_icon($item, 'TS_fact_icon', 'TS_fact_selected_icon'); ?>
                                                </div>
                                            <?php endif; ?>
                                        <?php else : ?>
                                            <div class="icon">
                                                <?php if (!empty($item['TS_fact_image']['url'])): ?>
                                                <img src="<?php echo $item['TS_fact_image']['url']; ?>" alt="<?php echo get_post_meta(attachment_url_to_postid($item['TS_fact_image']['url']), '_wp_attachment_image_alt', true); ?>">
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="services__style__two__content">
                                        <?php if (!empty($item['TS_fact_title' ])): ?>
                                        <h3 class="title">
                                            <?php if ($item['TS_fact_link_switcher'] == 'yes') : ?>
                                            <a href="<?php echo esc_url($link); ?>"><?php echo TS_kses($item['TS_fact_title' ]); ?></a>
                                            <?php else : ?>
                                                <?php echo TS_kses($item['TS_fact_title' ]); ?>
                                            <?php endif; ?>
                                        </h3>
                                        <?php endif; ?>

                                        <?php if (!empty($item['TS_fact_description' ])): ?>
                                        <p><?php echo TS_kses($item['TS_fact_description']); ?></p>
                                        <?php endif; ?>
         ...
         <section class="counter__area">
            <div class="container">
               <div class="counter__inner grey-bg-2ss">
                  <div class="row">
                    <?php foreach ($settings['TS_fact_list'] as $key => $item) :
                        $border_none = ($key == 3) ? '' : 'counter__item-border';
                    ?>
                     <div class="col-xl-<?php echo esc_attr($settings['TS_col_for_desktop']); ?> col-lg-<?php echo esc_attr($settings['TS_col_for_laptop']); ?> col-md-<?php echo esc_attr($settings['TS_col_for_tablet']); ?> col-<?php echo esc_attr($settings['TS_col_for_mobile']); ?>">
                        <div class="counter__item d-flex align-items-start ts-el-content <?php echo esc_attr($border_none); ?>">
                           ...
                           <div class="counter__content">
                            <?php if (!empty($item['TS_fact_title' ])): ?>
                            <h3 class="ts-el-title"><?php echo TS_kses($item['TS_fact_title' ]); ?></h3>
                            <?php endif; ?>
                            <?php if (!empty($item['TS_fact_number' ])): ?>
                              <h4 class="ts-el-subtitle"><span class="counter"><?php echo TS_kses($item['TS_fact_number' ]); ?></span>+</h4>
                            <?php endif; ?>
                            <?php if (!empty($item['TS_fact_description' ])): ?>
                                <p><?php echo TS_kses($item['TS_fact_description']); ?></p>
                            <?php endif; ?>
...
$widgets_manager->register( new TS_Fact() );