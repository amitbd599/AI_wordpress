 ...
 * @since 1.0.0
 */
class TS_Categories extends Widget_Base {
    use TS_Style_Trait;
    /**
    ...
    protected function register_controls_section() {
        ...
        $this->start_controls_section(
            'TS_categories',
            [
                'label' => esc_html__('Category List', 'TScore'),
        ...
        $this->add_control(
            'TS_course_link',
            [
                'label' => esc_html__('More Button Link', 'TScore'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('#', 'TScore'),
                'placeholder' => esc_html__('Course Link', 'TScore'),
                'label_block' => true,
            ]
        );
    ...
    protected function style_tab_content()
    {
        ...
        $this->TS_basic_style_controls('cat_title', 'Category Title', '.ts-el-cat');
    ...
    protected function render() {
        ...
        <?php else:
            $this->add_render_attribute('title_args', 'class', 'section__title-2 section__title-2-30 ts-el-title');
            // Link
            if ('2' == $settings['TS_btn_link_type']) {
                ...
                $this->add_render_attribute('ts-button-arg', 'class', 'ts-btn-5');
            } else {
                if ( ! empty( $settings['TS_btn_link']['url'] ) ) {
                    $this->add_link_attributes( 'ts-button-arg', $settings['TS_btn_link'] );
                    $this->add_render_attribute('ts-button-arg', 'class', 'ts-btn-5 ts-el-btn');
                }
            }
        ?>

         <section class="category__area ts-el-sec">
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4">
                     <div class="category__wrapper">
                        <div class="section__title-wrapper-2">
                            ...
                            <span class="section__title-pre-2 ts-el-subtitle">
                  ...
                  <div class="col-xxl-8 col-xl-8 col-lg-8">
                     <div class="category__item-wrapper">
                        <div class="row">
                           ...
                           <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                              <div class="category__item elementor-repeater-item-<?php echo esc_attr($item['_id']); ?> text-center mb-45">
                                    ...
                                    <a target="<?php echo esc_attr($target); ?>" rel="<?php echo esc_attr($rel); ?>" href="<?php echo esc_url($link); ?>">
                                        <?php if($item['TS_features_icon_type'] !== 'image') : ?>
                                            <?php if (!empty($item['TS_features_icon']) || !empty($item['TS_features_selected_icon']['value'])) : ?>
                                                <span class="cat__icon"><?php TS_render_icon($item, 'TS_features_icon', 'TS_features_selected_icon'); ?></span>
                                            <?php endif; ?>
                                        <?php else : ?>
                                            <span class="cat__icon">
                                                <?php if (!empty($item['TS_features_image']['url'])): ?>
                                                <img class="light" src="<?php echo $item['TS_features_image']['url']; ?>" alt="<?php echo get_post_meta(attachment_url_to_postid($item['TS_features_image']['url']), '_wp_attachment_image_alt', true); ?>">
                                                <?php endif; ?>
                                            </span>
                                        <?php endif; ?>
                                    </a>
                                 ...
                                 <div class="category__content">
                                    ...
                                    <h4 class="category__title ts-el-cat">
                           ...
                           <?php if (!empty($settings['TS_course_link'])): ?>
                           <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">
                              <div class="category__item text-center mb-45">
                                 <div class="category__icon add">
                                    <a href="<?php echo esc_url($settings['TS_course_link']); ?>">+</a>
                                 </div>
                                 <div class="category__content">
                                    <h4 class="category__title add">
                                       <a href="<?php echo esc_url($settings['TS_course_link']); ?>"><?php echo esc_html__('All Course','TScore'); ?></a>
                                    </h4>
                                 </div>
                              </div>
                           </div>
...
$widgets_manager->register( new TS_Categories() );