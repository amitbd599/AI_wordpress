...
class TS_Testimonial extends Widget_Base {
	...
	protected function register_controls_section() {
        ...
        $repeater->add_control(
            'reviewer_name', [
                ...
                'default' => esc_html__( 'Rasalina William' , 'TScore' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'review_sub', [
                'label' => esc_html__( 'Reviewe Subject', 'TScore' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( 'Code Quality!' , 'TScore' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'reviewer_title', [
                'label' => esc_html__( 'Reviewer Title', 'TScore' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__( '- CEO at YES Germany' , 'TScore' ),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'reviewer_name' => esc_html__( 'Rasalina William', 'TScore' ),
                        'reviewer_title' => esc_html__( '- CEO at YES Germany', 'TScore' ),
                        'review_content' => esc_html__( 'Put your trust in us &share in our people with a passion.We are motivated by the satisfaction H.Spond Asset Management is made up of a team of expert, committed and experienced for of clients financial markets. Our goal is to achieve continuous.', 'TScore' ),
                    ],
                    [
                        'reviewer_name' => esc_html__( 'Rasalina William', 'TScore' ),
                        'reviewer_title' => esc_html__( '- CEO at YES Germany', 'TScore' ),
    ...
    protected function style_tab_content()
    {
        ...
        $this->TS_basic_style_controls('heading_name', 'Name', '.ts-el-name');
        $this->TS_basic_style_controls('heading_designation', 'Designation', '.ts-el-des');
                ...
                <div class="row">
                    <?php foreach ($settings['reviews_list'] as $index => $item) :
                        if ( !empty($item['reviewer_image']['url']) ) {
                            $TS_reviewer_image = !empty($item['reviewer_image']['id']) ? wp_get_attachment_image_url( $item['reviewer_image']['id'], $settings['thumbnail_size_size']) : $item['reviewer_image']['url'];
                            $TS_reviewer_image_alt = get_post_meta($item["reviewer_image"]["id"], "_wp_attachment_image_alt", true);
                        }
                    ?>
                  <div class="col-lg-6 col-md-6">
                    <div class="reviewblock reviewblock--style2 ts-el-sec">
                      <div class="reviewblock__content">
                        <div class="reviewblock__author">
                          <?php if ( !empty($TS_reviewer_image) ) : ?>
                          <div class="reviewblock__authorImage">
                            <img src="<?php echo esc_url($TS_reviewer_image); ?>" alt="<?php echo esc_url($TS_reviewer_image_alt); ?>">
                          </div>
                          <?php endif; ?>

                          <?php if ( !empty($item['reviewer_name']) ) : ?>
                          <h3 class="reviewblock__authorName ts-el-name"><?php echo TS_kses($item['reviewer_name']); ?></h3>
                          <?php endif; ?>
                          <?php if ( !empty($item['review_content']) ) : ?>
                          <p class="ts-el-content reviewblock__authorSpeech"><?php echo TS_kses($item['review_content']); ?></p>
                          <?php endif; ?>
                          <?php if ( !empty($item['reviewer_title']) ) : ?>
                          <span class=" ts-el-des reviewblock__authorDes"><?php echo TS_kses($item['reviewer_title']); ?></span>
                          <?php endif; ?>
                        </div>
                      </div>
                    </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide col-6">
                  <div class="review__box mb-30">
                    <div class="reviewblock reviewblock--style3 text-center ts-el-sec">
                      <div class="reviewblock__content">
                        <div class="reviewblock__author">
                          <?php if ( !empty($TS_reviewer_image) ) : ?>
                          <img class="reviewblock__author__image" src="<?php echo esc_url($TS_reviewer_image); ?>" alt="<?php echo esc_url($TS_reviewer_image_alt); ?>">
                          <?php endif; ?>

                          <?php if ( !empty($item['reviewer_name']) ) : ?>
                          <span class="reviewblock__author__name ts-el-name d-block mb-25"><?php echo TS_kses($item['reviewer_name']); ?></span>
                          <?php endif; ?>
                          <br>
                          <?php if ( !empty($item['reviewer_title']) ) : ?>
                          <span class="reviewblock__authorDes ts-el-des"><?php echo TS_kses($item['reviewer_title']); ?></span>
                          <?php endif; ?>
                        </div>
                        <span class="reviewblock__quoteIcon__one">
                        <svg width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="htTS://www.w3.org/2000/svg">
                          <path
                        ...
                        <?php if ( !empty($item['review_content']) ) : ?>
                        <h4 class="reviewblock__qotes ts-el-content">“ <?php echo TS_kses($item['review_content']); ?> “</h4>
                        <?php endif; ?>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-xxl-12">
                     <div class="testimonial__slider">
                        <div class="testimonial__active owl-carousel">
                            ...
                            ?>
                          <div class="testimonial__item transition-3 text-center white-bg ts-el-sec">
                            <?php if ( !empty($TS_reviewer_image) ) : ?>
                            ...
                            <?php endif; ?>
                             ...
                             <div class="testimonial__text">
                                ...
                                <h4 class="ts-el-title"><?php echo TS_kses($item['review_sub']); ?></h4>
                                <?php endif; ?>

                                <?php if ( !empty($item['review_content']) ) : ?>
                                <p class=" ts-el-content"><?php echo TS_kses($item['review_content']); ?></p>
                                <?php endif; ?>

                             </div>
                             <div class="testimonial__avater-info mb-5">
                                <?php if ( !empty($item['reviewer_name']) ) : ?>
                                <h3 class="ts-el-name" ><?php echo TS_kses($item['reviewer_name']); ?></h3>
                                <?php endif; ?>
                                <?php if ( !empty($item['reviewer_title']) ) : ?>
                                <span class="ts-el-des" ><?php echo TS_kses($item['reviewer_title']); ?></span>
                                <?php endif; ?>
                             </div>
...
$widgets_manager->register( new TS_Testimonial() );