 ...
 * @since 1.0.0
 */
class TS_Tutor_Course extends Widget_Base {
	...
	protected function register_controls_section() {
		...
		$this->start_controls_section(
            'TS_tutor_query',
            [
                'label' => esc_html__('Tutor Query', 'TScore'),
            ]
        );
        ...
        $this->start_controls_section(
            'TS_campaign',
            [
                'label' => esc_html__('Tutor - Layout', 'TScore'),
            ]
        );
        $this->add_control(
            'TS_design_style',
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Grid Style 1', 'TScore'),
                    'layout-2' => esc_html__('Grid Style 2', 'TScore'),
                    'layout-3' => esc_html__('Grid Style 3', 'TScore'),
                    'layout-4' => esc_html__('Grid Style 4', 'TScore'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->add_control(
            'TS_image_show',
            [
                'label' => esc_html__( 'Show Image', 'TScore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'TScore' ),
                'label_off' => esc_html__( 'Hide', 'TScore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'TS_prcie_show',
            [
                'label' => esc_html__( 'Show Price', 'TScore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'TScore' ),
                'label_off' => esc_html__( 'Hide', 'TScore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'TS_cat_show',
            [
                'label' => esc_html__( 'Show Category', 'TScore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'TScore' ),
                'label_off' => esc_html__( 'Hide', 'TScore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'TS_author_show',
            [
                'label' => esc_html__( 'Show Author', 'TScore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'TScore' ),
                'label_off' => esc_html__( 'Hide', 'TScore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'TS_lessons_show',
            [
                'label' => esc_html__( 'Show Lessons', 'TScore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'TScore' ),
                'label_off' => esc_html__( 'Hide', 'TScore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'TS_duration_show',
            [
                'label' => esc_html__( 'Show Duration', 'TScore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'TScore' ),
                'label_off' => esc_html__( 'Hide', 'TScore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'TS_rating_show',
            [
                'label' => esc_html__( 'Show Rating', 'TScore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'TScore' ),
                'label_off' => esc_html__( 'Hide', 'TScore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'TS_students_show',
            [
                'label' => esc_html__( 'Show Students', 'TScore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'TScore' ),
                'label_off' => esc_html__( 'Hide', 'TScore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show difficulty', 'TScore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'TScore' ),
                'label_off' => esc_html__( 'Hide', 'TScore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show wishlist', 'TScore' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'TScore' ),
                'label_off' => esc_html__( 'Hide', 'TScore' ),
                'return_value' => 'yes',
        ...
        // TS_tutor_columns_section
        $this->start_controls_section(
            'TS_tutor_columns_section',
            [
                'label' => esc_html__('Tutor - Columns', 'TScore'),
            ]
        );

        $this->add_control(
            'TS_tutor__for_desktop',
            [
        ...
        // TS_tutor_slider_columns_section
		$this->start_controls_section(
            'TS_tutor_slider_columns_section',
            [
                'label' => esc_html__('Tutor - Columns for Carousel', 'TScore'),
            ]
        );

        $this->add_control(
            'TS_tutor_slider_for_xl_desktop',
            [
	...
	protected function render() {
        ...
        $carousel_args = [
            'arrows' => ('yes' === $settings['TS_tutor_arrow']),
            'dots' => ('yes' === $settings['TS_tutor_dots']),
            'autoplay' => ('yes' === $settings['TS_tutor_autoplay']),
            'autoplay_speed' => absint($settings['TS_tutor_autoplay_speed']),
            'infinite' => ('yes' === $settings['TS_tutor_infinite']),
            'for_xl_desktop' => absint($settings['TS_tutor_slider_for_xl_desktop']),
            'slidesToShow' => absint($settings['TS_tutor_slider_for_desktop']),
            'for_laptop' => absint($settings['TS_tutor_slider_for_laptop']),
            'for_tablet' => absint($settings['TS_tutor_slider_for_tablet']),
            'for_mobile' => absint($settings['TS_tutor_slider_for_mobile']),
            'for_xs_mobile' => absint($settings['TS_tutor_slider_for_xs_mobile']),
        ];
            ...
            <div class="container">
               <div class="row">
                   ...
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                      <div class="course__item-2 transition-3 ts-el-sec white-bg mb-30 fix">
                           <?php if ('yes' === $settings['TS_image_show']): ?>
                         ...
                         <div class="course__content-2">
                            <div class="course__top-2 d-flex align-items-center justify-content-between">
                               <?php if ('yes' === $settings['TS_cat_show']): ?>
                               <?php if (!empty($terms)): ?>
                               ...
                               <?php if ('yes' === $settings['TS_prcie_show']): ?>
                            ...
                            <h3 class="ts-el-title course__title-2">
                            ...
                            ?>
                            <p class="ts-el-content"><?php print wp_trim_words(get_the_excerpt(get_the_ID()), $content_limit, ''); ?></p>
                            <?php endif; ?>

                            <div class="course__bottom-2 d-flex align-items-center justify-content-between">
                               <div class="course__action">
                                  <ul>
                                    <?php if ('yes' === $settings['TS_students_show']): ?>
                                     <li>
                                    ...
                                    <?php if ('yes' === $settings['TS_lessons_show']): ?>
                                     <li>
                                        <div class="course__action-item d-flex align-items-center">
                                           <div class="course__action-icon mr-5">
                                              <span>
                                     ...
                                     <?php if ('yes' === $settings['TS_rating_show']): ?>
                                     <li>
                                        <div class="course__action-item d-flex align-items-center">
                                           <div class="course__action-icon mr-5">
                                              <span>
                               ...
                               <?php if ('yes' === $settings['TS_author_show']): ?>
                ...
                <?php if($settings['TS_tutor_pagination'] == 'yes' && '-1' != $settings['posts_per_page'] ) : ?>
                    <div class="row">
                        <div class="col-lg-12">
               ...
               <div class="row">
                   ...
                   <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                       ...
                       <?php endif; ?>
                         ...
                         <div class="course__item-3 white-bg ts-el-sec transition-3 mb-30">
                            ...
                            <div class="course__content-3">
                               <h3 class="course__title-3 ts-el-title">
                                  <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                               </h3>
                                    ...
                                    <?php if ('yes' === $settings['TS_lessons_show']): ?>
                                     <li>
                                        <div class="course__lesson-3">
                                           <a href="#">
                                              <span>
                                                 <svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="htTS://www.w3.org/2000/svg">
                                              ...
                                              <?php echo $tutor_lesson_count; ?> <?php echo esc_html__('videos','TScore'); ?>
                                           </a>
                                        </div>
                                     </li>
                                     <?php endif; ?>
                                     ...
                                     <li>
                                        <div class="course__review-3">
                                           <a href="#">
                                              <span>
                                                 <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="htTS://www.w3.org/2000/svg">
                                               ...
                                               <?php
                                                ...
                                                ?>
                                                <?php echo esc_html__('Reviews','TScore'); ?>
                                           </a>
                                        </div>
                                     </li>
                                     <?php endif; ?>
                               ...
                               <div class="course__join">
                                  <a href="<?php the_permalink(); ?>" class="ts-btn-5 ts-btn-10 ts-el-btn"><?php echo TS_kses($settings['TS_btn_text']); ?></a>
                               </div>
                               <?php endif; ?>
            ...
            <div class="container">
               ...
               <div class="row grid">
                   ...
                   <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item <?php echo $item_classes; ?>">
                      <div class="course__item-2 transition-3 white-bg ts-el-sec mb-30 fix">
                           <?php if ('yes' === $settings['TS_image_show']): ?>
                           <div class="course__thumb-2 p-relative w-img fix">
                                <a href="<?php print get_the_permalink() ?>">
                                    <?php echo get_the_post_thumbnail(get_the_ID(), $settings['thumbnail_size']); ?>
                         ...
                         <div class="course__content-2">
                            ...
                            <h3 class="course__title-2 ts-el-title">
                               <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                            </h3>
                                    ...
                                    <?php if ('yes' === $settings['TS_lessons_show']): ?>
                                     <li>
                                        <div class="course__action-item d-flex align-items-center">
                                           ...
                                           <div class="course__action-content">
                                              <span class="ts-el-content"><?php echo $tutor_lesson_count; ?></span>
                                           </div>
                                        </div>
                                     </li>
                                     <?php endif; ?>
         ...
         <section class="course__area">
            <div class="container">
               <div class="row">
                    ...
                    ?>
                    <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                        <div class="course__item white-bg transition-3 mb-30 ts-el-sec">
                           <?php if ('yes' === $settings['TS_image_show']): ?>
                           ...
                           <div class="course__content p-relative">
                              ...
                              <div class="course__tag">
                                <?php foreach ($terms as $term) : ?>
                                    <a class="ts-el-subtitle" href="<?php echo get_term_link($term->slug, 'course-category'); ?>"><?php echo $term->name; ?></a>
                                <?php endforeach; ?>
                              </div>
                              <?php endif; ?>
                              <?php endif; ?>

                              <h3 class="course__title ts-el-title">
                                 <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                              </h3>
                              ...
                              <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                                <?php if ('yes' === $settings['TS_author_show']): ?>
                                 ...
                                 <div class="course__lesson">
                                    <a href="<?php print get_the_permalink() ?>"><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="htTS://www.w3.org/2000/svg">
                                       ...
                                       <?php echo $tutor_lesson_count; ?> <?php print esc_html__('lessons', 'TScore'); ?>
                                    </a>
                                 </div>
                                 <?php endif; ?>
                              </div>
...
$widgets_manager->register( new TS_Tutor_Course() );