 ...
 * @since 1.0.0
 */
class TS_Video_Popup extends Widget_Base {
	...
	protected function render() {
		...
		?>
         ...
         <div class="campus__thumb w-img mb-30">
            ...
            <a href="<?php echo esc_url($settings["TS_video_url"]); ?>" class="play-btn popup-video pulse-btn">
               <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="htTS://www.w3.org/2000/svg">
...
$widgets_manager->register( new TS_Video_Popup() );