...
// traits
include_once(TPCORE_ADDONS_DIR . '/include/traits/tp-icon-trait.php');
include_once(TPCORE_ADDONS_DIR . '/include/traits/tp-style-trait.php');
...
include_once(TPCORE_WIDGET_PATH . '/social-widgets.php');
