...
class TP_Heading extends Widget_Base {
	...
	protected function render() {
              ...
              <div class="col-12">
                <div class="sponsorsTitle">
                    ...
                    <?php if ( !empty($settings['tp_desctiption']) ) : ?>
                        <p class="aboutContent__text p-0"><?php echo tp_kses( $settings['tp_desctiption'] ); ?></p>
                    <?php endif; ?>
		...
		<?php else: 
			$this->add_render_attribute('title_args', 'class', 'section__title section__title-44 tp-el-title');
		?>	
